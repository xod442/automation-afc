...
try:
   ...
   # Start Lesson 2 code here  
    print("Discovering Switches...")
    devices.discover_switches(info['switch_list'],   # Get the python list of switches
                                              auth_header,          # This is the auth header
                                              info['username'],    # The username for logging into the switch
                                              info['switch_pass'], # The switch password
                                              **session_dict)       # Session key
    print('Waiting 30 seconds for switches to onboard to add to fabric')
    time.sleep(30)
